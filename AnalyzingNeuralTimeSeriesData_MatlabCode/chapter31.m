...
% 
% My note: There is some doubts in variable "tempsynch", the calculation of
% threshold from "tempsynch" didn't correspond to the specified frequency.
% 
...
use_real_network = true; % if false, simulate a network (true/false for Figures 13/14)
