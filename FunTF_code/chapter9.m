...
% compute phase velocity (remember from chapter 8 that this value, when
...
% For example, to test for mean stationarity, re-run the code for chapter 9.1 and then:
...
% Next, try re-running the code for chapter 9.2 and then the following lines.
