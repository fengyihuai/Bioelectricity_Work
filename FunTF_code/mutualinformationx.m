function [mi entropy fd_bins pval] = mutualinformationx(x,y,fd_bins,permtest)
% MUTUALINFORMATIONX   Compute mutual information between two vectors
%  
% [mi entropy fd_bins,pval] = mutualinformationx(x,y,fd_bins,permtest)
% 
%   Inputs:
...
%       pval    :  probability of observing a mutual information value as large
%                  as the observed value by chance
%
